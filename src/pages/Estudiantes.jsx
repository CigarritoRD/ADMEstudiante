    ...
    <>
      {loading ? (
        ...
        <div className='bg-slate-100 p-4 min-h-screen'>
          ...
          <div className='rounded p-2 gap-2  flex justify-between'>
              ...
              <form action=''>
                ...
                <div className='flex gap-2 items-center'>
                  <input
                    ...
                    name='filtrar'
                    className='border p-2 rounded my-2 min-w-[300px] w-full shadow'
                    type='text'
                    placeholder='Escribe algo para filtrar'
                  />
                  <input
                    className='border rounded px-4 py-2 bg-slate-800 text-white hover:bg-slate-900 duration-200 cursor-pointer'
                    type='submit'
                    value='buscar'
                  />
                </div>
